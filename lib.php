...
/**
 * Saves a new instance of the mod_contentscheduler into the database.
 *
...
/**
 * Removes an instance of the mod_contentscheduler from the database.
 *
...
function contentscheduler_delete_instance($id) {
    ...
    $DB->delete_records('contentscheduler', array('id' => $id));
